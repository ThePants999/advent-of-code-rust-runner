...
pub trait DayImplementation {
    ...
    fn execute_part_2<'a>(&self, input: &'a str, context: Self::Context<'a>) -> Self::Output<'a>;

    fn run_with_input<'a>(&self, input: &'a str) -> ExecutionResult<Self::Output<'a>> {
...
pub trait Day {
    ...
    fn test_day(&self) -> TestResult;
    fn execute_day(&self) -> DayResult;
}
...
impl<T: DayImplementation> Day for T {
    ...
    fn test_day(&self) -> TestResult {
        ...
        TestResult::from_execution_result(result, DayImplementation::example_part_1_result(self), DayImplementation::example_part_2_result(self))
    }
    ...
    fn execute_day(&self) -> DayResult {
        ...
        DayResult::from(self.run_with_input(input))
    }
}